...
# Tile Targets
#**********************
set(TARGET_NAME tile0_example_freertos_video_example)
...
set(TARGET_NAME tile1_example_freertos_video_example)
add_executable(${TARGET_NAME} EXCLUDE_FROM_ALL)
target_sources(${TARGET_NAME} PUBLIC ${APP_SOURCES})
target_include_directories(${TARGET_NAME} PUBLIC ${APP_INCLUDES})
...
# Merge binaries
#**********************
merge_binaries(example_freertos_video_example tile0_example_freertos_video_example tile1_example_freertos_video_example 1)
