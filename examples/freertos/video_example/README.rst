...
.. tab:: Linux and Mac
    ...
    .. code-block:: console
        ...
        cd build
        make example_freertos_video_example
...
.. tab:: Windows
    ...
    .. code-block:: console
        ...
        cd build
        nmake example_freertos_video_example
...
.. tab:: Linux and Mac
    ...
    .. code-block:: console
        ...
        make flash_fs_example_freertos_video_example

.. tab:: Windows

    .. code-block:: console

        nmake flash_fs_example_freertos_video_example
...
.. tab:: Linux and Mac
    ...
    .. code-block:: console
        ...
        make run_example_freertos_video_example

.. tab:: Windows

    .. code-block:: console

        nmake run_example_freertos_video_example
...
.. tab:: Linux and Mac
    ...
    .. code-block:: console
        ...
        make debug_example_freertos_video_example

.. tab:: Windows

    .. code-block:: console

        nmake debug_example_freertos_video_example
